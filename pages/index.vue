<template>
  <div
    class="w-full h-screen flex flex-row items-center justify-center bg-slate-900"
  >
    <div class="w-1/2 flex flex-col items-center space-y-8">
      <h1 class="font-bold text-8xl text-white">
        DungeonRun
      </h1>
      <h2 class="font-bold text-6xl text-white">
        Infinite
      </h2>
    </div>
    <div class="w-1/2 flex justify-center">
      <div
        class="w-1/2 flex flex-col items-center justify-center space-y-4"
      >
        <NuxtLink
          to="start"
